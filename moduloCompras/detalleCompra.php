...
$sqlTodosLosArticulos="SELECT * FROM `articulos` where idEsta=1";
...
<!--     <button class="btn aqua-gradient" data-toggle="modal" data-target="#centralModalSuccess">Añadir producto</button>
 -->
    ...
    <tbody>
    <?php $total=0; foreach ($entradas as $key): $total+=$key['cantidad']*$key['costo']?>
    ...
    <tfoot>
        <tr style="text-align: center;">
            ...
            <td style="font-size: 150%;" colspan="5">$<?php echo $total?></td>
        </tr>
    </tfoot>
    </table>
    </div>
